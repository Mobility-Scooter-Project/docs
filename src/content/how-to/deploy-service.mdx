...
Argo will apply your changes whenever you commit to main or develop, depending on how the cluster admin has it configured. Admins can check
the status of applications via the ArgoCD UI or with the following command:
```sh
